...
export const LEAD_COLUMNS =
  "id, company_id, score, score_breakdown, source_label, source_query, fit_feedback, agent_id, created_at, people(full_name, title), companies(name, domain, country, county, caen, phone, address), emails(address, status, confidence, is_role_address), lists(id, name)";
